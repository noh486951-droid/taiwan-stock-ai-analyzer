...
![Version](https://img.shields.io/badge/Version-11.10-blue)
...
- **Discord 智慧通知系統 (v11.10)**: 實裝全自動 Discord 機器人推送。包含 11 種觸發情境（進出場、階梯預警、鴨子要飛了、量能激增、尾盤摜壓、總經提醒等），具備台股配色卡片與分級頻率控制，實現無人值守的即時風險控管與績效追蹤。
